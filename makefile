...
CFLAGS = -std=gnu99 -DCPU_LPC54608J512ET180=1 -DLWIP_TIMEVAL_PRIVATE=0 -DMG_ARCH=MG_ARCH_ARMGCC -DMG_ENABLE_FREERTOS=1 -DMG_ENABLE_LWIP=1 -DCPU_LPC54608J512ET180_cm4 -DCPU_LPC54608 -D__USE_CMSIS -DUSE_RTOS=1 -DPRINTF_ADVANCED_ENABLE=1 -DSERIAL_PORT_TYPE_UART=1 -DFSL_RTOS_FREE_RTOS -DSDK_DEBUGCONSOLE=0 -DCR_INTEGER_PRINTF -DPRINTF_FLOAT_ENABLE=0 -D__MCUXPRESSO -DDEBUG -D__NEWLIB__ -O0 -fno-common -g3 -Wall -c  -ffunction-sections  -fdata-sections  -ffreestanding  -fno-builtin -fmerge-constants -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -D__NEWLIB__ -fstack-usage -DMAKEBUILD

LINKFLAGS =	-nostdlib -L"./libs" -Xlinker --gc-sections -Xlinker --sort-section=alignment -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -T lpcxpresso54608_lwip_tcpecho_freertos_Debug.ld
